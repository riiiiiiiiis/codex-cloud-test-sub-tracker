window.TRANSLATIONS = {
  ru: {
    ...
    landing: {
      ...
      heroBadge: 'Обновление 2024 · Новый облик',
      heroMetaRetention: 'подписок остаются активными после первого месяца',
      heroMetaMinutes: 'минут на запуск учёта',
      heroMetaSync: 'синхронизация устройств без сложной настройки',
      heroFootnote: 'Используйте демо-данные или импортируйте свои подписки — контроль всегда остаётся за вами.',
      heroVisualTitle: 'Демо-портфель подписок',
      heroVisualMonthly: 'Траты в месяц',
      heroVisualSaved: 'Экономия за год',
      heroVisualTomorrow: 'Списание завтра',
      heroVisualInTwo: 'Через 2 дня',
      heroVisualNextWeek: 'На следующей неделе',
  ...
  en: {
    ...
    landing: {
      ...
      heroBadge: '2024 refresh · New look',
      heroMetaRetention: 'subscriptions stay active after month one',
      heroMetaMinutes: 'minutes to get organised',
      heroMetaSync: 'device sync without complex setup',
      heroFootnote: 'Use demo data or import your own subscriptions — the ownership always stays with you.',
      heroVisualTitle: 'Demo subscription wallet',
      heroVisualMonthly: 'Monthly spend',
      heroVisualSaved: 'Yearly savings',
      heroVisualTomorrow: 'Charge tomorrow',
      heroVisualInTwo: 'In 2 days',
      heroVisualNextWeek: 'Next week',
